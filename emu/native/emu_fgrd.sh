...
if [[ $? -ne 0 ]]; then
    ...
    echo "can be generated by EMU's Modified Simulation Tool using a replacement "
    echo "file called 'data' that specifies the period of model integration. "
    echo "Such 'data' file can also be generated by EMU's Auxiliary Tool (which "
    echo "runs misc_msim_data.sh)."
    echo 
