pro plot_atrb, frun, atrb, atrb_mn, atrb_sec, fctrl
...
atrb_sec = lonarr(nrec)
close,1 & openr,1,aa,/swap_if_little_endian
readu,1,atrb_sec
close,1
print,'*********************************************'
print,'Read variable '
print,'   atrb_sec: sample time (seconds from 1/1/1992 12Z)' 
print,'from file ',aa
print,''

atrb_t = (atrb_sec/24.)/365. + 1992. 
...
plot,atrb_t,atrb(*,0),Title=frun_file,ynozero=1,xtitle='atrb_sec',ytitle='atrb',xrange=[tmin,tmax],xstyle=1
